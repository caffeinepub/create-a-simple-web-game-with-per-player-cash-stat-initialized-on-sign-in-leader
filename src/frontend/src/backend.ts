...
export class Backend implements backendInterface {
    ...
    async claimStarterReward(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.claimStarterReward();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async enforceAdminCashLeadership(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.enforceAdminCashLeadership(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCash(): Promise<Cash> {
        if (this.processError) {
            try {
                const result = await this.actor.getCash();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCashLeaderboard(arg0: bigint): Promise<Array<LeaderboardEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCashLeaderboard(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlayerStatus(): Promise<Player> {
        if (this.processError) {
            try {
    ...
    async initializeCash(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeCash();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async upgradeSpeed(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.upgradeSpeed();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
